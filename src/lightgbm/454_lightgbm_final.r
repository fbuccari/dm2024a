...
PARAM$finalmodel$learning_rate <- 0.0392486973897262
PARAM$finalmodel$feature_fraction <- 0.660040973583075
PARAM$finalmodel$min_data_in_leaf <- 814
PARAM$finalmodel$num_leaves <- 397
...
for (envios in cortes) {
  ...
  fwrite(tb_entrega[, list(numero_de_cliente, Predicted)],
    file = paste0(PARAM$experimento, "_", envios,"_", PARAM$finalmodel$num_iterations ,".csv"),
    sep = ","
  )
}
